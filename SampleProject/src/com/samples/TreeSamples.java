...
//		createAndCheckIsSymmetric();
	...
	public static void checkLCAinBST(){
		...
		System.out.println("2: LCA for 0 and 5: " + TreeSamples.lowestCommonAncestorInBST(root, child2Left, child4Right).val);
		System.out.println("6: LCA for 4 and 7: " + TreeSamples.lowestCommonAncestorInBST(root, child2Right, child8Left).val);
		System.out.println("2: LCA for 2 and 3: " + TreeSamples.lowestCommonAncestorInBST(root, child6Left, child4Left).val);
		System.out.println("6: LCA for 3 and 8: " + TreeSamples.lowestCommonAncestorInBST(root, child4Left, child6Right).val);
